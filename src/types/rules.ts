import type { EslintCommentsRules, EslintRules, ImportRules, JsoncRules, MergeIntersection, NRules, Prefix, ReactRules, RenamePrefix, RuleConfig, TypeScriptRules, UnicornRules, Unprefix, VueRules, YmlRules } from '@antfu/eslint-define-config';
