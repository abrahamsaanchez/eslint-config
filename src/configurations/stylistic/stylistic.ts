...
import type { StylisticConfiguration } from '../../types/stylistic-configuration';

/**
 * Generates the `stylistic` rules for the received configuration.
 *
 * @param configuration
 */
export function stylistic(configuration: StylisticConfiguration): ConfigurationItems {
    ...
    // Return the `stylistic` rules
    return [
        {
            name: 'abrahamsaanchez:stylistic',
            plugins: {
                antfu: pluginAntfu,
